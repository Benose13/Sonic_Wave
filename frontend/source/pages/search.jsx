...
import { Row, FIlterSearch, LoadMore } from "../plugins";
...
const Search = () => {
  ...
  const onLoad = async () => {
    ...
    try {
      ...
      if (typeof err?.response?.data?.message === "string") {
        ...
        alert("Facing An Error(Music Search)");
      }
  ...
  useEffect(() => {
    document.title = `SonicWave - Search ${searchParams.get("q") || ""}`;
    ...
    <div className="container">
      ...
      {!response?.empty ? (
        ...
        <Error
          customErr={{
            status: 404,
            statusText: "Data not found in SonicWave database.",
          }}
        />
      )}
    </div>
